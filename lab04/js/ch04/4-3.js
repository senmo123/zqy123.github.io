...
window.onload = function initCube() {
    ...
    dLoc = gl.getUniformLocation(program, "dl");
    gl.uniform3fv(dLoc, dl);

    sLoc = gl.getUniformLocation(program, "sl");
    gl.uniform3fv(sLoc, sl);
    ...
    document.getElementById("sx").onchange = function(){
        sl[0] = document.getElementById("sx").value;
    }
    document.getElementById("sy").onchange = function(){
        sl[1] = document.getElementById("sy").value;
    }
    document.getElementById("sz").onchange = function(){
        sl[2] = document.getElementById("sz").value;
    }
    render();
}
